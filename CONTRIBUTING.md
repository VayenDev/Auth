# Contributing to Vayen Auth

Hey there! 👋

We’re super excited that you want to contribute to **Vayen Auth**. It’s an open-source, high-performance Minecraft
...
3. **Open the project**
   Open the `Vayen Auth` folder in your favorite IDE (IntelliJ IDEA or VS Code with Kotlin plugins work great). Gradle
...
4. **Run the project**
   ...
   This will build everything you need and start the Vayen Auth client.
...
*[Discussion](https://github.com/VayenDev/Auth/discussions)**.

Thanks for helping make Vayen Auth even better! We really appreciate it. 💜